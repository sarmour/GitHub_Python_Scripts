...
if __name__ == '__main__':
    import timeit
    print(timeit.timeit("pop_sample()",number = 1000, setup="from __main__ import pop_sample"))
    print(timeit.timeit("ipop_sample()", number = 1000,setup="from __main__ import ipop_sample"))
